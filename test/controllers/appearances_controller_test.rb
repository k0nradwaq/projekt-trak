...
class AppearancesControllerTest < ActionController::TestCase
  ...
  test "should create appearance" do
    assert_difference('Appearance.count') do
      post :create, appearance: { active: @appearance.active, startjob: @appearance.startjob, starttime: @appearance.starttime }
    end
  ...
  test "should update appearance" do
    patch :update, id: @appearance, appearance: { active: @appearance.active, startjob: @appearance.startjob, starttime: @appearance.starttime }
    assert_redirected_to appearance_path(assigns(:appearance))
  end
